...
RESULTS_PATH = "models/efficientnetb3_results.json"
...
def plot_history(history):
    ...
    plt.savefig("ketqua/efficientnetb3.png", dpi=200)
    print("Đã lưu biểu đồ huấn luyện tại 'ketqua/efficientnetb3.png'")
    plt.show()
...
def main():
    ...
    print(f"\nBắt đầu huấn luyện EfficientNetB3...")
